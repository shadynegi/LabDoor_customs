...
"use strict";var LiquidWeb=(()=>{var U=Object.defineProperty;var Z=Object.getOwnPropertyDescriptor;var J=Object.getOwnPropertyNames;var F=Object.prototype.hasOwnProperty;var V=(s,t)=>{for(var e in t)U(s,e,{get:t[e],enumerable:!0})},k=(s,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of J(t))!F.call(s,n)&&n!==e&&U(s,n,{get:()=>t[n],enumerable:!(i=Z(t,n))||i.enumerable});return s};var j=s=>k(U({},"__esModule",{value:!0}),s);var X={};V(X,{default:()=>W});var c=class extends Error{constructor(t,e){super(t),this.name="LiquidWebError",this.originalError=e}};var b={init:!0,scale:22,blur:2,saturation:170,aberration:50,mode:"standard"};var L={on(s,t,e){let i=this;if(!i.eventsListeners||i.destroyed||typeof t!="function")return i;let n=e?"unshift":"push";return(Array.isArray(s)?s:s.split(" ")).forEach(A=>{i.eventsListeners[A]||(i.eventsListeners[A]=[]),i.eventsListeners[A][n](t)}),i},once(s,t,e){let i=this;if(!i.eventsListeners||i.destroyed||typeof t!="function")return i;function n(...r){Array.isArray(s)?s.forEach(A=>i.off(A,n)):i.off(s,n),n.__emitterProxy&&delete n.__emitterProxy,t.apply(i,r)}return n.__emitterProxy=t,i.on(s,n,e)},onAny(s,t){let e=this;if(!e.eventsListeners||e.destroyed||typeof s!="function")return e;let i=t?"unshift":"push";return e.eventsAnyListeners.indexOf(s)<0&&e.eventsAnyListeners[i](s),e},offAny(s){let t=this;if(!t.eventsListeners||t.destroyed||!t.eventsAnyListeners)return t;let e=t.eventsAnyListeners.indexOf(s);return e>=0&&t.eventsAnyListeners.splice(e,1),t},off(s,t){let e=this;if(!e.eventsListeners||e.destroyed)return e;let i=[];return Array.isArray(s)?i=s:typeof s=="string"&&(i=s.split(" ")),i.forEach(n=>{typeof t>"u"?e.eventsListeners[n]=[]:e.eventsListeners[n]&&e.eventsListeners[n].forEach((r,A)=>{(r===t||r.__emitterProxy&&r.__emitterProxy===t)&&e.eventsListeners[n].splice(A,1)})}),e},emit(...s){let t=this;if(!t.eventsListeners)return t;let e,i,n;return typeof s[0]=="string"||Array.isArray(s[0])?(e=s[0],i=s.slice(1,s.length),n=t):(e=s[0].events,i=s[0].data,n=s[0].context||t),i.unshift(n),(Array.isArray(e)?e:e.split(" ")).forEach(A=>{t.eventsAnyListeners&&t.eventsAnyListeners.length&&t.eventsAnyListeners.forEach(o=>{o.apply(n,[A,...i])}),t.eventsListeners&&t.eventsListeners[A]&&t.eventsListeners[A].forEach(o=>{o.apply(n,i)})}),t}};var y={handleMouseEnter(){this.state.isHovered=!0,this.update(),this.emit("mouseEnter",this)},handleMouseLeave(){this.state.isHovered=!1,this.update(),this.emit("mouseLeave",this)},handleMouseDown(){this.state.isActive=!0,this.update(),this.emit("mouseDown",this)},handleMouseUp(){this.state.isActive=!1,this.update(),this.emit("mouseUp",this)},handleMouseMove(s){this.state.globalMousePos={x:s.clientX,y:s.clientY},this.state.mouseOffset={x:s.offsetX||s.layerX,y:s.offsetY||s.layerY},this.update(),this.emit("mouseMove",this)},handleClick(){this.emit("click",this)},handleResize(){this.update()}};var w={destroy(){if(!this.destroyed)return this.emit("beforeDestroy"),this.$el.removeEventListener("mouseenter",this.handleMouseEnter),this.$el.removeEventListener("mouseleave",this.handleMouseLeave),this.$el.removeEventListener("mousedown",this.handleMouseDown),this.$el.removeEventListener("mouseup",this.handleMouseUp),this.$el.removeEventListener("click",this.handleClick),document.removeEventListener("mousemove",this.handleMouseMove),window.removeEventListener("resize",this.handleResize),this.$svg?.remove(),this.$svg=null,this.$backdrop?.remove(),this.$backdrop=null,this.$el?.appendChild?.(this.$content),this.$el?.querySelector(".liquidweb__content")?.remove(),this.$el?.classList.remove("liquidweb"),this.$el?.classList.remove("liquidweb-initialized"),this._observer&&(this._observer.disconnect(),this._observer=null),this.emit("destroy"),this.$el&&(N.__instances__.delete(this.$el),delete this.$el.liquidweb),this.eventsListeners={},this.eventsAnyListeners=[],this.initialized=!1,this.destroyed=!0,this.emit("afterDestroy"),null}};var C={getInstance(s){return new this(void 0,{init:!1}).getInstance(s)},init(s){return new this(void 0,{init:!1}).init(s)}};var d=class extends Error{constructor(t,e){super(t),this.name="LiquidWebError",this.originalError=e}},B=class{setup(t,e){return this.instance=t,this.validateElement(e),this.createStructure(e),t.$content=this.$content,t.$backdrop=this.$backdrop,t.$svg=this.$svg,this}validateElement(t){if(!t)throw new d("Element is required");if(!(t instanceof Element))throw new d("Invalid element type. Expected HTMLElement")}createStructure(t){if(this.$el=t,this.$el.children.length>1)throw new d("Liquid container must have exactly one child element");if(this.$el.children.length===0)throw new d("Liquid container must have at least one child element");this.$content=this.$el.children[0],this.$svg=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.$svg.style.position="absolute",this.$svg.style.width="100%",this.$svg.style.height="100%",this.$svg.setAttribute("aria-hidden","true");let e=document.createElementNS("http://www.w3.org/2000/svg","defs"),i=this.instance.createSVGFilter();for(e.appendChild(i),this.$svg.appendChild(e),this.$el.classList.add("liquidweb"),this.$el.style.borderRadius=`${this.instance.options.cornerRadius}px`;this.$el.firstChild;)this.$el.removeChild(this.$el.firstChild);this.$backdrop=document.createElement("span"),this.$backdrop.className="liquidweb__backdrop";let n=document.createElement("div");n.className="liquidweb__content",n.appendChild(this.$content),this.$el.appendChild(this.$svg),this.$el.appendChild(this.$backdrop),this.$el.appendChild(n)}};function I(s){return s!==null&&typeof s=="object"&&"constructor"in s&&s.constructor===Object}function q(s){return typeof window<"u"&&typeof window.HTMLElement<"u"?s instanceof window.HTMLElement:s&&typeof s=="object"&&s.nodeType===1&&typeof s.nodeName=="string"}function m(...s){let[t,...e]=s,i=["__proto__","constructor","prototype"];if(!t)return{};for(let n of e){if(!n||q(n))continue;let r=Object.keys(Object(n)).filter(A=>!i.includes(A));for(let A of r){let o=Object.getOwnPropertyDescriptor(n,A);if(!o||!o.enumerable)continue;let h=n[A],a=t[A];I(h)?h.__liquidweb__?t[A]=h:I(a)?m(a,h):t[A]=m({},h):t[A]=h}}return t}function x(s,t,e){return e=Math.max(0,Math.min(1,(e-s)/(t-s))),e*e*(3-2*e)}function Y(s,t){return Math.sqrt(s*s+t*t)}function H(s,t,e,i,n){let r=Math.abs(s)-e+n,A=Math.abs(t)-i+n;return Math.min(Math.max(r,A),0)+Y(Math.max(r,0),Math.max(A,0))-n}function P(s,t){return{x:s,y:t}}var K={liquidGlass:s=>{let t=s.x-.5,e=s.y-.5,i=H(t,e,.3,.2,.6),n=x(.8,0,i-.15),r=x(0,1,n);return P(t*r+.5,e*r+.5)}},T=class{constructor(t){this.options=t,this.canvas=document.createElement("canvas"),this.canvasDPI=1,this.canvas.width=t.width*this.canvasDPI,this.canvas.height=t.height*this.canvasDPI,this.canvas.style.display="none";let e=this.canvas.getContext("2d");if(!e)throw new Error("Could not get 2D context");this.context=e}updateShader(t){let e=this.options.width*this.canvasDPI,i=this.options.height*this.canvasDPI,n=0,r=[];for(let a=0;a<i;a++)for(let l=0;l<e;l++){let u={x:l/e,y:a/i},E=this.options.fragment(u,t),g=E.x*e-l,p=E.y*i-a;n=Math.max(n,Math.abs(g),Math.abs(p)),r.push(g,p)}n>0?n=Math.max(n,1):n=1;let A=this.context.createImageData(e,i),o=A.data,h=0;for(let a=0;a<i;a++)for(let l=0;l<e;l++){let u=r[h++],E=r[h++],g=Math.min(l,a,e-l-1,i-a-1),p=Math.min(1,g/2),O=u*p,v=E*p,G=O/n+.5,R=v/n+.5,f=(a*e+l)*4;o[f]=Math.max(0,Math.min(255,G*255)),o[f+1]=Math.max(0,Math.min(255,R*255)),o[f+2]=Math.max(0,Math.min(255,R*255)),o[f+3]=255}return this.context.putImageData(A,0,0),this.canvas.toDataURL()}destroy(){this.canvas.remove()}getScale(){return this.canvasDPI}};var S="data:image/jpeg;base64,",z="data:image/jpeg;base64,",D="data:image/png;base64,";var M={eventsEmitter:L,actions:y,destroy:w},Q=class s{static __instances__=new Map;static __stylesInjected__=!1;static __styleElement__=null;static init=C.init;static getInstance=C.getInstance;constructor(...t){let e,i;if(window.requestAnimationFrame=function(n){return setTimeout(n,0)},t.length===1&&t[0].constructor&&Object.prototype.toString.call(t[0]).slice(8,-1)==="Object"?i=t[0]:[e,i]=t,i||(i={}),i=m({},i),e&&!i.el&&(i.el=e),this.$el||(this.$el=i.el),this.$el&&typeof this.$el=="string"){let n=document.querySelectorAll(this.$el),r=Array.from(n).map(A=>{if(s.__instances__.has(A))return s.__instances__.get(A);let o=m({},i,{el:A}),h=new s(o);return s.__instances__.set(A,h),h});return new Proxy(r,{get(A,o){return Array.prototype[o]?A[o].bind(A):["on","once","onAny","off","offAny","emit","init","destroy"].includes(o)?(...a)=>(A.map(l=>l[o].apply(l,a)),A):typeof A[0][o]=="function"?A[0][o].bind(A[0]):A[0][o]}})}this.options=m({},b,i),this.__liquidweb__=!0,this.eventsListeners={},this.eventsAnyListeners=[],this.options&&this.options.on&&Object.keys(this.options.on).forEach(n=>{this.on(n,this.options.on[n])}),this.options&&this.options.onAny&&this.onAny(this.options.onAny),this.destroyed=!1,this.initialized=!1,this.DOMManager=new B,this.state={isHovered:!1,isActive:!1,mouseOffset:{x:0,y:0},globalMousePos:{x:0,y:0},glassSize:{width:0,height:0}},this.filterId=Math.random().toString(36).substr(2,9),s.__stylesInjected__||s.injectStyles(),this.$el instanceof Element&&(s.__instances__.set(this.$el,this),this.$el.liquidweb=this),this.$el&&this.$el.parentNode?this.options.init&&this.init():console.warn("Element must be in DOM before initialization")}init(t=this.$el){if(!this.initialized){if(!t)throw new c("Element is required");if(!(t instanceof Element))throw new c("Element must be a DOM Element");this.destroyed=!1,this.emit("beforeInit");try{this.emit("init",this),this.DOMManager.setup(this,t),this.initialized=!0,this.$content&&(this.$content.liquidweb=this,this.$el.classList.add("liquidweb-initialized")),this.$el&&s.__instances__.set(this.$el,this),this.update()}catch(e){throw new c("Initialization failed",e)}this.attachEventListeners(),this.update(),this.emit("afterInit")}}static injectStyles(){if(s.__stylesInjected__||typeof document>"u")return;let t=`
    ...
    `;s.__styleElement__=document.createElement("style"),s.__styleElement__.type="text/css",s.__styleElement__.appendChild(document.createTextNode(t)),document.head.appendChild(s.__styleElement__),s.__stylesInjected__=!0}createSVGFilter(){let t=document.createElementNS("http://www.w3.org/2000/svg","filter");t.setAttribute("id",this.filterId),t.setAttribute("x","-35%"),t.setAttribute("y","-35%"),t.setAttribute("width","170%"),t.setAttribute("height","170%"),t.setAttribute("colorInterpolationFilters","sRGB");let e=this.getDisplacementMap(),i=document.createElementNS("http://www.w3.org/2000/svg","feImage");return i.setAttribute("x","0"),i.setAttribute("y","0"),i.setAttribute("width","100%"),i.setAttribute("height","100%"),i.setAttribute("result","DISPLACEMENT_MAP"),i.setAttribute("href",e),i.setAttribute("preserveAspectRatio","xMidYMid slice"),t.appendChild(i),this.setupFilterEffects(t),t}setupFilterEffects(t){let e=document.createElementNS("http://www.w3.org/2000/svg","feColorMatrix");e.setAttribute("in","DISPLACEMENT_MAP"),e.setAttribute("type","matrix"),e.setAttribute("values","0.3 0.3 0.3 0 0 0.3 0.3 0.3 0 0 0.3 0.3 0.3 0 0 0 0 0 1 0"),e.setAttribute("result","EDGE_INTENSITY");let i=document.createElementNS("http://www.w3.org/2000/svg","feComponentTransfer");i.setAttribute("in","EDGE_INTENSITY"),i.setAttribute("result","EDGE_MASK");let n=document.createElementNS("http://www.w3.org/2000/svg","feFuncA");n.setAttribute("type","discrete"),n.setAttribute("tableValues",`0 ${this.options.aberration*.05} 1`),i.appendChild(n),t.appendChild(e),t.appendChild(i),this.addChannelDisplacement(t,"RED"),this.addChannelDisplacement(t,"GREEN"),this.addChannelDisplacement(t,"BLUE"),this.combineChannels(t)}addChannelDisplacement(t,e){let i=this.options.scale*(this.options.mode==="shader"?1:-1),n=e==="RED"?0:e==="GREEN"?.05:.1,r=document.createElementNS("http://www.w3.org/2000/svg","feDisplacementMap");r.setAttribute("in","SourceGraphic"),r.setAttribute("in2","DISPLACEMENT_MAP"),r.setAttribute("scale",i-this.options.aberration*n),r.setAttribute("xChannelSelector","R"),r.setAttribute("yChannelSelector","B"),r.setAttribute("result",`${e}_DISPLACED`);let A=document.createElementNS("http://www.w3.org/2000/svg","feColorMatrix");A.setAttribute("in",`${e}_DISPLACED`),A.setAttribute("type","matrix");let o=new Array(20).fill(0);e==="RED"&&(o[0]=1),e==="GREEN"&&(o[6]=1),e==="BLUE"&&(o[12]=1),o[18]=1,A.setAttribute("values",o.join(" ")),A.setAttribute("result",`${e}_CHANNEL`),t.appendChild(r),t.appendChild(A)}combineChannels(t){let e=document.createElementNS("http://www.w3.org/2000/svg","feBlend");e.setAttribute("in","GREEN_CHANNEL"),e.setAttribute("in2","BLUE_CHANNEL"),e.setAttribute("mode","screen"),e.setAttribute("result","GB_COMBINED");let i=document.createElementNS("http://www.w3.org/2000/svg","feBlend");i.setAttribute("in","RED_CHANNEL"),i.setAttribute("in2","GB_COMBINED"),i.setAttribute("mode","screen"),i.setAttribute("result","RGB_COMBINED");let n=document.createElementNS("http://www.w3.org/2000/svg","feGaussianBlur");n.setAttribute("in","RGB_COMBINED"),n.setAttribute("stdDeviation",Math.max(.1,.5-Number(this.options.aberration)*.1)),n.setAttribute("result","ABERRATED_BLURRED"),t.appendChild(e),t.appendChild(i),t.appendChild(n)}getDisplacementMap(){switch(this.options.mode){case"standard":return S;case"polar":return z;case"prominent":return D;case"shader":return this.generateShaderDisplacementMap();default:return this.generateShaderDisplacementMap()}}generateShaderDisplacementMap(){if(!this.$el)throw new c("Element must be in DOM to generate shader map");let{width:t,height:e}=this.$el.getBoundingClientRect(),i=new T({width:t,height:e,fragment:K.liquidGlass}),n=i.updateShader();return i.destroy(),n}attachEventListeners(){this.$el&&(this.$el.addEventListener("mouseenter",t=>this.handleMouseEnter(t)),this.$el.addEventListener("mouseleave",t=>this.handleMouseLeave(t)),this.$el.addEventListener("mousedown",t=>this.handleMouseDown(t)),this.$el.addEventListener("mouseup",t=>this.handleMouseUp(t)),this.$el.addEventListener("mousemove",t=>this.handleMouseMove(t)),this.$el.addEventListener("click",t=>this.handleClick(t)),window.addEventListener("resize",()=>this.handleResize()),this.setupMutationObserver())}setupMutationObserver(){if(!this.$content||typeof MutationObserver>"u")return;let t=new MutationObserver(e=>{let i=!1;for(let n of e)if(n.type==="attributes"&&(n.attributeName==="style"||n.attributeName==="class")){i=!0;break}i&&this.updateBackdropBorderRadius()});t.observe(this.$content,{attributes:!0,attributeFilter:["style","class"]}),this._observer=t}updateBackdropBorderRadius(){if(!this.$content||!this.$backdrop)return;let t=window.getComputedStyle(this.$content),e=t.borderTopLeftRadius,i=t.borderTopRightRadius,n=t.borderBottomRightRadius,r=t.borderBottomLeftRadius,A=2,o=h=>{if(!h)return"0px";let a=h.match(/^([\d.]+)(.*)$/);if(!a)return h;let[,l,u]=a;return`${Math.max(0,parseFloat(l)-A)}${u}`};this.$backdrop.style.borderTopLeftRadius=o(e),this.$backdrop.style.borderTopRightRadius=o(i),this.$backdrop.style.borderBottomRightRadius=o(n),this.$backdrop.style.borderBottomLeftRadius=o(r)}update(){if(this.emit("beforeUpdate"),!this.$el)throw new c("Container element not found");let t=this.$el.getBoundingClientRect();this.state.glassSize={width:t.width,height:t.height},this.emit("update",this),window.requestAnimationFrame(()=>{this.updateBackdropBorderRadius(),this.updateEffects(),this.emit("afterUpdate",this)})}updateEffects(){if(this.emit("beforeUpdateEffects"),this.$backdrop){let t=typeof this.options.blur=="number"?`${this.options.blur}px`:this.options.blur,e=typeof this.options.saturation=="number"?`${this.options.saturation}%`:this.options.saturation,i=navigator.userAgent.toLowerCase().includes("firefox");this.$backdrop.style.filter=i?"":`url(#${this.filterId})`,this.$backdrop.style.backdropFilter=`blur(${t}) saturate(${e})`,this.emit("updateEffects",this),this.emit("afterUpdateEffects",this)}}};Object.keys(M).forEach(s=>{Object.keys(M[s]).forEach(t=>{Q.prototype[t]=M[s][t]})});var N=Q;var W=N;return j(X);})();
window.LiquidWeb = LiquidWeb.default || LiquidWeb; })();

//# sourceMappingURL=liquid-core.min.js.map
