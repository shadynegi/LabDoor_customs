...
- **``** — topic guides (setup, deploy, checkout, orders, QA checklists)
...
| **Admin** | Bulk updates max **500** IDs; manual mark paid with external `payment_id` + admin note (WhatsApp checkout); paid orders cannot cancel or refund; product cards on mobile. |
