...
| Test suite alignment | ✅ 666 tests | No obsolete PayPal route tests in tree |
...
2. `npm test` (666 + viewport audit) before merge.
...
| [`test_guidelines.md`](test_guidelines.md) | Test inventory (666) |
