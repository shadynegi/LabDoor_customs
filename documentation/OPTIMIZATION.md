...
| Test suite alignment | ✅ 668 tests | No obsolete PayPal route tests in tree |
...
2. `npm test` (668 + viewport audit) before merge.
...
| [`test_guidelines.md`](test_guidelines.md) | Test inventory (668) |
