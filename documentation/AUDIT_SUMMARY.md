...
**Automated tests:** 668 (143 backend unit + 88 API + 13 frontend unit + 423 Playwright + 1 viewport) plus viewport overflow audit — see [`test_guidelines.md`](test_guidelines.md) and [`Tests/README.md`](../Tests/README.md).
