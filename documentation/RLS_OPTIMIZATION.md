...
**Production status (June 2026):** All required SQL migrations in `backend/src/database/` are applied. Use verification queries in [SUPABASE_SQL_TO_RUN.md](./SUPABASE_SQL_TO_RUN.md) only for new databases or audits.
