...
**Test count marker (CI should match):** `<!-- tests: 668 -->` (143 unit + 88 API + 13 frontend unit + 423 Playwright + 1 viewport)
...
| DOC-TESTS | Test count in `info.md` | `info.md` | `npm test` (668) | COVERED |
